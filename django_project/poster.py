...
# print(urls)
for url in urls:
    url_list[url.id] = [url.poster_path, url.genre.all()]


idx = 0
for id in url_list.keys():
    # 라벨용 이름
    # genre_vector = list('0000000000000000000')
    # 이미지 URL
    image_url = f'http://image.tmdb.org/t/p/w300{url_list[id][0]}'
    ...
    if response.status_code == 200:
        ...
        image.save(f'C:/Users/SSAFY/Desktop/find_poster/download_poster/{id}.jpg')
